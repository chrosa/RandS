...
TFitConstraintEp::TFitConstraintEp(vector<TAbsFitParticle*>* particles,
      TFitConstraintEp::component thecomponent, Double_t constraint, Double_t normalization) :
   TAbsFitConstraint(normalization), _particles(0), _constraint(constraint), _component(
         thecomponent) {
...
TFitConstraintEp::TFitConstraintEp(const TString &name, const TString &title, vector<
      TAbsFitParticle*>* particles, TFitConstraintEp::component thecomponent, Double_t constraint,
      Double_t normalization) :
   TAbsFitConstraint(name, title, normalization), _particles(0), _constraint(constraint),
...
void TFitConstraintEp::addParticles(TAbsFitParticle* p1, TAbsFitParticle* p2, TAbsFitParticle* p3,
