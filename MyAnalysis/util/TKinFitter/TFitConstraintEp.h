...
class TFitConstraintEp: public TAbsFitConstraint {
   ...
   public:
      ...
      TFitConstraintEp(const TString &name, const TString &title,
            vector<TAbsFitParticle*>* particles, TFitConstraintEp::component thecomponent,
            Double_t constraint = 0., Double_t normalization = 1.);
      virtual ~TFitConstraintEp();

      void addParticle(TAbsFitParticle* particle);
      void addParticles(TAbsFitParticle* p1, TAbsFitParticle* p2 = 0, TAbsFitParticle* p3 = 0,
