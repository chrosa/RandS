...
class TFitConstraintMGaus: public TFitConstraintM {
   ...
   public:
      ...
      TFitConstraintMGaus();
      TFitConstraintMGaus(vector<TAbsFitParticle*>* ParList1, vector<TAbsFitParticle*>* ParList2,
            Double_t Mass = 0, Double_t Width = 0, Double_t normalization = 1.);
      TFitConstraintMGaus(const TString &name, const TString &title,
            vector<TAbsFitParticle*>* ParList1, vector<TAbsFitParticle*>* ParList2, Double_t Mass =
                  0, Double_t Width = 0, Double_t normalization = 1.);
