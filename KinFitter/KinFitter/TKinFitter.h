...
class TKinFitter: public TNamed {
   ...
   public:
      ...
      void addUnmeasParticles(TAbsFitParticle* p1, TAbsFitParticle* p2 = 0,
            TAbsFitParticle* p3 = 0, TAbsFitParticle* p4 = 0, TAbsFitParticle* p5 = 0,
            TAbsFitParticle* p6 = 0, TAbsFitParticle* p7 = 0, TAbsFitParticle* p8 = 0,
   ...
   private:
      ...
      TMatrixD _deltaAstar; // The correction vector deltaA for unmeasured particles of the last iteration
      TMatrixD _deltaY; // The correction vector deltaY for measured particles of the last iteration
      TMatrixD _deltaYstar; // The correction vector deltaY for measured particles of the last iteration
