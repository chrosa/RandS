...
class TFitConstraintM: public TAbsFitConstraint {
   ...
   public:
      ...
      TFitConstraintM();
      TFitConstraintM(vector<TAbsFitParticle*>* ParList1, vector<TAbsFitParticle*>* ParList2,
            Double_t Mass = 0, Double_t normalization = 1.);
      ...
      void addParticles2(TAbsFitParticle* p1, TAbsFitParticle* p2 = 0, TAbsFitParticle* p3 = 0,
            TAbsFitParticle* p4 = 0, TAbsFitParticle* p5 = 0, TAbsFitParticle* p6 = 0,
            TAbsFitParticle* p7 = 0, TAbsFitParticle* p8 = 0, TAbsFitParticle* p9 = 0,
            TAbsFitParticle* p10 = 0);
